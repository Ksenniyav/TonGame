...
$(document).ready(async function () {
    ...
    //   }
      ...
      imgSrc.src = "../media/content/point.svg";
      let netNameText = document.createTextNode('Oasis');
      let netNameTag = document.createElement("span");
      netNameTag.append(netNameText);
      walletDisconnect.append(netNameTag);
      walletDisconnect.append(imgSrc);
